...
- **`app.rs`**: Central `App` struct (~1980 lines) — holds all application state, implements `eframe::App`. Orchestrates:
...
- **`core/`**: Business logic layer (18 modules)
- **`ui/`**: GUI presentation layer (6 modules + nested instance views)
