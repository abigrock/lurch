...
## Responsibility
Instance management UI — instance list/grid, creation dialogs, modpack browsing, and routing to per-instance detail views. Heaviest UI submodule (~6100 LOC).
...
| Module | LOC | Purpose |
|--------|-----|---------|
| `mod.rs` | ~1150 | `InstancesView`: instance list, modpack view delegation; delegates create/edit to child modules |
...
| `detail/` | ~3000 | Per-instance detail view with tabbed content management |
