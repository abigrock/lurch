            ...
            .show(ui, |ui| {
                ...
                egui::CollapsingHeader::new(header_text)
                    ...
                    .show(ui, |ui| {
                        ...
                        let mut render_theme_cards =
                            |ui: &mut egui::Ui, range: std::ops::Range<usize>| {
                                ui.horizontal_wrapped(|ui| {
                                    ...
                                    for i in range {
                                        ...
                                        if ui.is_rect_visible(rect) {
                                            ...
                                            let swatch_start_x =
                                                rect.center().x - swatches_total / 2.0;
                                            for (j, color_name) in
                                                ["accent", "surface", "fg"].iter().enumerate()
                                            {
                                                let sx = swatch_start_x
                                                    + j as f32 * (swatch_w + swatch_gap);
                        ...
                        ui.allocate_ui_with_layout(
                            ...
                            |ui| {
                                ...
                                if open_clicked && let Ok(dir) = crate::util::paths::themes_dir() {
                                    let _ = open::that(dir);
                                }
                                ui.label(
                                    theme.subtext(
                                        "Drop .json theme files here to add custom themes.",
                                    ),
                                );
                            },
                        );
                ...
                let header_text = theme
                    .section_header(&format!("{} Java Runtime", egui_phosphor::regular::COFFEE));
                egui::CollapsingHeader::new(header_text)
                    .default_open(false)
                    ...
                    .show(ui, |ui| {
                        ...
                        let provider_installed_majors: std::collections::HashSet<u32> =
                            java_installs
                                .iter()
                                .filter(|j| {
                                    j.managed
                                        && if self.java_provider == 0 {
                                            j.vendor == "Mojang"
                                        } else {
                                            j.vendor == "Adoptium"
                                        }
                        ...
                        let already_installed =
                            provider_installed_majors.contains(&self.java_version);
                        ...
                        ui.allocate_ui_with_layout(
                            ...
                            |ui| {
                                ...
                                let btn = ui.add_enabled(
                                    !is_downloading && !already_installed,
                        ...
                        if download_clicked {
                            ...
                            let state =
                                Arc::new(Mutex::new(crate::core::java::JavaDownloadState {
                                    version,
                                ...
                                std::thread::spawn(move || {
                                    ...
                                    let result = client.map_err(|e| e.to_string()).and_then(|c| {
                                        ...
                                        java::download_mojang_java(&c, &component, move |msg| {
                                            state_for_cb.lock_or_recover().message =
                                                msg.to_string();
                        ...
                        ui.allocate_ui_with_layout(
                            ...
                            |ui| {
                                let rescan_lbl =
                                    format!("{} Re-scan", egui_phosphor::regular::MAGNIFYING_GLASS);
                                        ...
                                        |ui| {
                                            ...
                                            if install.managed {
                                                ui.with_layout(
                                                    ...
                                                    |ui| {
                                                        let btn =
                                                            ui.add(theme.danger_button(&format!(
                                                                "{} Remove",
                    ...
                    .show(ui, |ui| {
                        ...
                        egui::Grid::new("settings_memory_grid")
                            ...
                            .show(ui, |ui| {
                                ...
                                ui.add(
                                    egui::Slider::new(
                                        &mut config.default_min_memory_mb,
                                        256..=max_for_min,
                                    )
                                    .step_by(256.0)
                                    .text("MB")
                                ...
                                ui.add(
                                    egui::Slider::new(
                                        &mut config.default_max_memory_mb,
                                        min_for_max..=16384,
                                    )
                                    .step_by(256.0)
                                    .text("MB")
                            ...
                            .changed()
                        {
                            config.default_jvm_args =
                                args_edit.split_whitespace().map(String::from).collect();
                        }
                    });
                ui.add_space(16.0);
